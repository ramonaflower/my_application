...
public class Constants {
    public static final int REQUEST_PERMISSIONS_CODE_CAMERA_AND_WRITE_EXTERNAL_STORAGE = 21;
    public static final int REQUEST_PERMISSIONS_CODE_READ_EXTERNAL_STORAGE = 22;
    public static final int REQUEST_CODE_CAPTURE_FIRST_IMAGE_INSURANCE = 23;
